...
//Name: PounceAnim.ma
//Last modified: Tue, Dec 05, 2023 10:50:39 PM
//Codeset: 1252
...
fileInfo "UUID" "21C5F8BF-46F5-215B-177F-FBA98C36E89D";
createNode transform -s -n "persp";
	rename -uid "9D2BA417-4A90-599D-9878-50AD9EB2B256";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -92.613803257277212 26.719805130370773 -73.135894806981298 ;
	setAttr ".r" -type "double3" -8.1383527296013316 -489.39999999989686 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0006D327-434B-4209-BBBD-A8A2988C9B68";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 152.3372938984495;
...
createNode transform -n "AnimCam";
	...
	setAttr ".t" -type "double3" -83.900028297925175 40.255499774816982 -70.373040774029988 ;
	setAttr ".r" -type "double3" -8.3999999999998849 -122.39999999999947 0 ;
createNode camera -n "AnimCamShape" -p "AnimCam";
	...
	setAttr ".ff" 0;
	setAttr ".coi" 117.46413690068434;
	setAttr ".ow" 30;
...
createNode reference -n "PALBotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 41.14020803671250803 61.34452934287608628 0"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN" 
		"rotate" " -type \"double3\" 0 -104.09724213236182777 0"
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "FCEF4167-4864-F70C-F35A-23997B18D0A9";
