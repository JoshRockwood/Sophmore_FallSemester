...
//Last modified: Tue, Oct 24, 2023 11:03:42 PM
//Codeset: 1252
...
fileInfo "UUID" "FB56B70B-4C5B-5A78-895E-DF877F6AAD0B";
createNode transform -s -n "persp";
	rename -uid "4B0BFC6F-47FE-FBCE-3DD7-B58FFC9288CB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -26.635336760179587 25.783600531871372 47.853426059721521 ;
	setAttr ".r" -type "double3" -14.138352723542635 1406.1999999999448 -9.5686345505441474e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E04CD5B7-472F-8092-1AC3-3FAF0D46F726";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 59.236482817525825;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "48391D82-45AC-2220-1F89-EA90E23AA047";
	setAttr -s 17 ".lnk";
	setAttr -s 17 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "00F1009F-4429-821F-4364-DD9299F8ED99";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E5530269-4B50-74CA-39F8-36B02AA67D76";
createNode displayLayerManager -n "layerManager";
	rename -uid "7F7DDB84-4C67-5AD9-F67B-549BD1CCD79E";
createNode displayLayer -n "defaultLayer";
	rename -uid "5321F186-45EC-8BF3-8621-6AB93A08F52A";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CF9853FE-497A-EB37-74BD-47BDAD98DF5E";
...
createNode animCurveTA -n "PALbot_MAIN_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 0 11 0 14 0 16 0 18 0 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Engine_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 4 0 6 0 8 0 14 0 16 0 18 0 21 0;
	setAttr -s 8 ".kit[7]"  1;
	setAttr -s 8 ".kot[7]"  1;
	setAttr -s 8 ".kix[7]"  1;
	setAttr -s 8 ".kiy[7]"  0;
...
createNode animCurveTA -n "PALbot_L_IK_Foot_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 111.02261763628292 4 96.653786260968857
		 6 -23.918207769197373 8 -26.922484193319715 11 -27.784054947907837 14 -2.837 16 -2.837
		 18 130.84 21 111.02261763628292;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_IK_Foot_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 -16.153491589518502 6 -16.153491589518577
		 8 -16.153491589518577 11 -4.3353119559097424 14 0 16 0 18 4.983 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_IK_Foot_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 -1.8588744070541701 6 -1.8588744070542254
		 8 -1.8588744070542254 11 -0.30833626615345627 14 0 16 0 18 -12.082 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_IK_footBall_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 8.5522923651328941 6 -15.384843178405779
...
createNode animCurveTA -n "PALbot_L_foot_secondary_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 28.748063037047316 6 -52.109654049089549
		 8 -31.093531932737307 11 1.9882191138931091 14 1.9882191138931091 16 -7.0153756755509562
		 18 4.653558297109166 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_IK_Foot_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -50.675240351154621 4 -2.8365166516757196
		 6 -2.8365166516757196 8 130.84025737277034 11 111.023 14 96.654 16 -23.918 18 -26.922
		 21 -50.675240351154621;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_IK_Foot_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 4.9828547385866599 11 0 14 -16.153
		 16 -16.153 18 -16.153 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_IK_Foot_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 -12.082367325191752 11 0 14 -1.8589999999999998
		 16 -1.8589999999999998 18 -1.8589999999999998 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_IK_footBall_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -4.7790436333187154 4 -0.65680612605354305
		 6 -4.8424103293772962 8 -14.351682410232113 11 4.7383654905655446 14 8.552 16 -15.385
		 18 -21.003 21 -4.7790436333187154;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_foot_secondary_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -34.364316796677024 4 9.3148052146614617
		 6 -7.1662391389645315 8 5.6927274000282351 11 34.952783528245924 14 34.952783528245924
		 16 -47.285239248279758 18 -34.6021861467528 21 -34.364316796677024;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_knee_aim_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 4 0 6 0 8 0 16 0 18 0 21 0;
	setAttr -s 7 ".kit[6]"  1;
	setAttr -s 7 ".kot[6]"  1;
	setAttr -s 7 ".kix[6]"  1;
	setAttr -s 7 ".kiy[6]"  0;
...
createNode animCurveTA -n "PALbot_L_Index01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 73.368647800356044 4 73.368647800356044
		 6 73.368647800356044 8 73.368647800356044 11 73.368647800356044 14 73.368647800356044
		 16 73.368647800356044 18 73.368647800356044 21 73.368647800356044;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Middle01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 79.80719147119764 4 79.80719147119764
		 6 79.80719147119764 8 79.80719147119764 11 79.80719147119764 14 79.80719147119764
		 16 79.80719147119764 18 79.80719147119764 21 79.80719147119764;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Pinky01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 84.785025540666865 4 84.785025540666865
		 6 84.785025540666865 8 84.785025540666865 11 84.785025540666865 14 84.785025540666865
		 16 84.785025540666865 18 84.785025540666865 21 84.785025540666865;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Pinky02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 90 4 90 6 90 8 90 11 90 14 90 16 90 18 90
		 21 90;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
...
createNode animCurveTA -n "PALbot_L_Thumb02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -12.846170327863131 4 -12.846170327863131
		 6 -12.846170327863131 8 -12.846170327863131 11 -12.846170327863131 14 -12.846170327863131
		 16 -12.846170327863131 18 -12.846170327863131 21 -12.846170327863131;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Thumb02_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -15.916145604792339 4 -15.916145604792339
		 6 -15.916145604792339 8 -15.916145604792339 11 -15.916145604792339 14 -15.916145604792339
		 16 -15.916145604792339 18 -15.916145604792339 21 -15.916145604792339;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Thumb03_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 27.533352575550083 4 27.533352575550083
		 6 27.533352575550083 8 27.533352575550083 11 27.533352575550083 14 27.533352575550083
		 16 27.533352575550083 18 27.533352575550083 21 27.533352575550083;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Index01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 65.557040851836845 4 65.557040851836845
		 6 65.557040851836845 8 65.557040851836845 11 65.557040851836845 14 65.557040851836845
		 16 65.557040851836845 18 65.557040851836845 21 65.557040851836845;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Index02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 70.16967870986295 4 70.16967870986295
		 6 70.16967870986295 8 70.16967870986295 11 70.16967870986295 14 70.16967870986295
		 16 70.16967870986295 18 70.16967870986295 21 70.16967870986295;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Middle01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 71.4025741032697 4 71.4025741032697 6 71.4025741032697
...
createNode animCurveTA -n "PALbot_R_Middle02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 84.426307777537673 4 84.426307777537673
		 6 84.426307777537673 8 84.426307777537673 11 84.426307777537673 14 84.426307777537673
		 16 84.426307777537673 18 84.426307777537673 21 84.426307777537673;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Pinky01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 81.694071575327683 4 81.694071575327683
		 6 81.694071575327683 8 81.694071575327683 11 81.694071575327683 14 81.694071575327683
		 16 81.694071575327683 18 81.694071575327683 21 81.694071575327683;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Ring01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 74.329228057122933 4 74.329228057122933
		 6 74.329228057122933 8 74.329228057122933 11 74.329228057122933 14 74.329228057122933
		 16 74.329228057122933 18 74.329228057122933 21 74.329228057122933;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Ring02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 88.645566831599965 4 88.645566831599965
		 6 88.645566831599965 8 88.645566831599965 11 88.645566831599965 14 88.645566831599965
		 16 88.645566831599965 18 88.645566831599965 21 88.645566831599965;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Thumb02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -10.768591854594996 4 -10.768591854594996
		 6 -10.768591854594996 8 -10.768591854594996 11 -10.768591854594996 14 -10.768591854594996
		 16 -10.768591854594996 18 -10.768591854594996 21 -10.768591854594996;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Thumb02_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -25.586486767241489 4 -25.586486767241489
		 6 -25.586486767241489 8 -25.586486767241489 11 -25.586486767241489 14 -25.586486767241489
		 16 -25.586486767241489 18 -25.586486767241489 21 -25.586486767241489;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_Thumb03_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 28.810989363471716 4 28.810989363471716
		 6 28.810989363471716 8 28.810989363471716 11 28.810989363471716 14 28.810989363471716
		 16 28.810989363471716 18 28.810989363471716 21 28.810989363471716;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_cog_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -25.38901821388114 4 -17.253732882611395
		 6 -22.457743204625661 8 -27.069874394169656 11 -22.800405042446808 14 -11.952780481382856
		 16 -12.187374302360574 18 -12.187374302360574 21 -25.38901821388114;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_cog_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 3.2287706643268863 4 7.5024962458882998
		 6 3.6282535477872115 8 1.2182378815321404 11 -3.1151143342016132 14 -2.6605178211107541
		 16 1.1542885533624487 18 1.1542885533624487 21 3.2287706643268863;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_cog_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 6.7678864267748153 4 15.969109832262209
		 6 3.9213170155944526 8 -1.8737788356666456 11 -10.362244120394726 14 -22.272384631310338
		 16 -4.5762329282219962 18 -4.5762329282219962 21 6.7678864267748153;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -14.869375139990357 4 -10.948747505147367
		 6 -19.328533764217113 8 -23.684094974093188 11 -19.887190546983639 14 -25.779704811438812
		 16 -26.546574182570531 18 -28.74397920338636 21 -14.869375139990357;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -9.5371268706542782 4 -7.8357276764247752
		 6 0.99018714821388076 8 12.038106717935928 11 18.446784855626575 14 21.4475466203194
		 16 8.5976059219704091 18 -14.824074612827262 21 -9.5371268706542782;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 9.588203687726045 4 15.854614496988326
		 6 7.0491760966568719 8 2.2451774146271557 11 0.27163245431128263 14 -8.6574496746606044
		 16 -4.5793402119251754 18 7.1832196227910954 21 9.588203687726045;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 70.054 4 85.197282725426405 6 -95.415776628448697
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 52.404 4 43.393263670410462 6 10.284296477715445
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -20.656000000000002 4 -20.656 6 -13.566355393607056
		 8 -13.566355393607056 11 -13.566355393607056 14 -17.695 16 -17.695 18 -17.695 21 -20.656000000000002;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_FK_Elbow_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -66.122 4 -75.326664920241569 6 -87.485072593633546
...
createNode animCurveTA -n "PALbot_L_FK_Wrist_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 10.127847404424827 6 -13.423560836809974
...
createNode animCurveTA -n "PALbot_L_FK_Wrist_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 0 11 1.6659859105434309 14 0
		 16 0 18 0 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
...
createNode animCurveTA -n "PALbot_L_FK_Wrist_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 0 11 2.6077881895411461 14 10.402
		 16 10.402 18 10.402 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_Neck_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 29.736810514712708 4 29.736810514712708
		 6 29.736810514712708 8 29.736810514712708 11 27.985456549900324 14 27.985456549900324
		 16 27.985456549900324 18 27.985456549900324 21 29.736810514712708;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_Neck_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 6.4093467117448677 4 6.4093467117448677
		 6 6.4093467117448677 8 6.4093467117448677 11 1.2143494981595049 14 1.2143494981595049
		 16 1.2143494981595049 18 1.2143494981595049 21 6.4093467117448677;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_Neck_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -11.057291941107453 4 -11.057291941107453
		 6 -11.057291941107453 8 -11.057291941107453 11 -2.0740662282172657 14 -2.0740662282172657
		 16 -2.0740662282172657 18 -2.0740662282172657 21 -11.057291941107453;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_head_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 27.094245297630852 4 25.276075990282923
		 6 26.527612559761362 8 28.197948642872678 11 27.602785885896704 14 22.712906353712835
		 16 26.833891995133516 18 25.518620663543381 21 27.094245297630852;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_head_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 9.4326238450962023 4 13.783361623079367
		 6 11.019896267450363 8 0.1262702425657235 11 -15.849573326074168 14 -22.458324888777238
		 16 -10.248836326622031 18 -3.6515554465694975 21 9.4326238450962023;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_head_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -8.9310020354109199 4 -17.942597099702873
		 6 -12.121550493768591 8 -1.1916738072717918 11 1.9550756122078263 14 16.759696625068631
		 16 6.369489755741613 18 -1.7030108683669942 21 -8.9310020354109199;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -118.296 4 -137.67106572596964 6 10.960550298111103
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateY1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -25.35 4 -25.35 6 59.039648819135763 8 59.039648819135763
		 11 59.039648819135763 14 43.393 16 10.284 18 10.284 21 -25.35;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateZ1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -17.695 4 -17.695 6 -17.695000000000036
...
createNode animCurveTA -n "PALbot_R_FK_Elbow_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -62.873999999999995 4 -43.453731011945699
		 6 -35.605161481828084 8 -48.69275238877303 11 -65.615458016390122 14 -75.327 16 -87.485
		 18 -51.559000000000005 21 -62.873999999999995;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTA -n "PALbot_R_FK_Wrist_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 -13.363833351887767 6 18.675687332143262
...
createNode animCurveTA -n "PALbot_R_FK_Wrist_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 10.402 4 10.401999999999987 6 10.402000000000031
		 8 10.402000000000029 11 10.402000000000031 14 0 16 0 18 0 21 10.402;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTU -n "PALbot_L_knee_aim_ctrl_space_switch";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 2 2 2 4 2 5 2 7 2 8 2 10 2 11 2 13 2;
...
createNode animCurveTL -n "PALbot_R_knee_aim_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 -6.6613381477509422e-16 4 0 6 0 8 0 16 0
		 18 0 21 0;
	setAttr -s 7 ".kit[6]"  1;
	setAttr -s 7 ".kot[6]"  1;
	setAttr -s 7 ".kix[6]"  1;
...
createNode animCurveTL -n "PALbot_R_knee_aim_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 2.6645352591003757e-15 4 0 6 0 8 0 16 0
		 18 0 21 0;
	setAttr -s 7 ".kit[6]"  1;
	setAttr -s 7 ".kot[6]"  1;
	setAttr -s 7 ".kix[6]"  1;
...
createNode animCurveTU -n "PALbot_R_knee_aim_ctrl_space_switch";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 2 4 2 6 2 8 2 16 2 18 2 21 2;
...
createNode animCurveTL -n "PALbot_L_Thumb01_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -4.9400951578258161e-05 4 -4.9400951578258161e-05
...
createNode animCurveTL -n "PALbot_L_Thumb01_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 1.7589953799286646e-05 4 1.7589953799286646e-05
		 6 1.7589953799286646e-05 8 1.7589953799286646e-05 11 1.7589953799286646e-05 14 1.7589953799286646e-05
		 16 1.7589953799286646e-05 18 1.7589953799286646e-05 21 1.7589953799286646e-05;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTL -n "PALbot_R_Engine_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 2.2204460492503131e-16 4 0 6 0 8 0 11 0
		 14 0 16 0 18 0 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
...
createNode animCurveTL -n "PALbot_R_Engine_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 6.9388939039072284e-18 4 0 6 0 8 0 11 0
		 14 0 16 0 18 0 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
...
createNode animCurveTU -n "PALbot_R_Engine_ctrl_scaleX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 1 4 1 6 1 8 1 11 1 14 1 16 1 18 1 21 1;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTL -n "PALbot_R_IK_Foot_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -0.22449203535647833 4 -0.22449203535647833
...
createNode animCurveTL -n "PALbot_R_IK_Foot_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 3.4602273877107752 4 1.3883930380212557
...
createNode animCurveTL -n "PALbot_head_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 -0.55122744402767399 11 -0.55122744402767399
		 14 -0.90019920520740826 16 -0.71840448487720321 18 -0.1341151646439312 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTL -n "PALbot_head_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 0.06390585243686274 11 0.06390585243686274
		 14 -0.026816819339261236 16 -0.030718984239145503 18 0.005706598627475897 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTL -n "PALbot_head_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 6 0 8 -0.024778632440593275 11 -0.024778632440593275
		 14 -0.39526114202054174 16 -0.35182009433479705 18 -0.48240340543706323 21 0;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTU -n "PALbot_head_ctrl_Led_color";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 2 4 2 6 2 8 2 11 2 14 2 16 2 18 2 21 2;
	setAttr -s 9 ".kit[0:8]"  9 9 9 9 9 9 9 9 
		1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTL -n "PALbot_L_Engine_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 -3.0057911164751421e-12 4 0 6 0 8 0 14 0
		 16 0 18 0 21 0;
	setAttr -s 8 ".kit[7]"  1;
	setAttr -s 8 ".kot[7]"  1;
	setAttr -s 8 ".kix[7]"  1;
...
createNode animCurveTU -n "PALbot_L_Engine_ctrl_scaleX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 1 4 1 6 1 8 1 14 1 16 1 18 1 21 1;
	setAttr -s 8 ".kit[7]"  1;
	setAttr -s 8 ".kot[7]"  1;
	setAttr -s 8 ".kix[7]"  1;
	setAttr -s 8 ".kiy[7]"  0;
...
createNode animCurveTL -n "PALbot_L_IK_Foot_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 6.2320152736350085 4 3.598153326675269
...
createNode animCurveTL -n "PALbot_L_IK_Foot_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -5.3360985311813467 4 -1.6724868588335702
		 6 2.2180817209842347 8 4.6701909103542247 11 4.6701909103542247 14 1.388 16 -3.462
		 18 -6.386 21 -5.3360985311813467;
	setAttr -s 9 ".kit[8]"  1;
	setAttr -s 9 ".kot[8]"  1;
	setAttr -s 9 ".kix[8]"  1;
	setAttr -s 9 ".kiy[8]"  0;
...
createNode animCurveTL -n "PALbot_cog_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 -1.2847550856958261 6 -0.18617141444762808
